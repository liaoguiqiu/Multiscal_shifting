...
parser.add_argument('--lr', type=float, default=0.00000005, help='learning rate, default=0.0002')
...
parser.add_argument('--netD', default="../out/DeepPathFinding_Version2/netD_epoch_38.pth", help="path to netD (to continue training)")
